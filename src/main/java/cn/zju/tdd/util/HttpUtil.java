...
public class HttpUtil {
	...
	public static void main(String args[]) {
		try {
			System.out.println(login("https://www.google.com/accounts/ServiceLoginAuth?service=lh2","username:cf.wfwei@gmail.com;password:wfwei@google","utf-8"));
			System.out.println(fetchPage("hhttps://www.google.com/settings/account"));
		} catch (Exception e) {
